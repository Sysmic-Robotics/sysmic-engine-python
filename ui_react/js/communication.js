...
server.on('message', (msg, rinfo) => {
	let paquete = EnginePackage.deserializeBinary(msg);
	let scene = paquete.getScene();

	// Get FPS
	Data.fps = paquete.getFps();

	// Get AIEnvironment
	if (paquete.getAiEnvironment().getName() == "default") {
		let environment = paquete.getAiEnvironment();
		Data.aiEnvironment = {
